  ...
  <Layout class="text-center">
    <div>
      ...
      <kinesis-container id="home" class="relative">
        ...
        <div>
          <h1 class="text-3xl font-bold mt-2">Benslimane Fares Houssem Eddin</h1>
          <vue-typed-js
            :strings="[
              'FullStack Developer',
              'Designer',
      ...
      <div id="about" class="about-section pt-12 my-24 flex">
        <div class="w-full lg:w-3/5 about-section__left text-left">
          ...
          <h4 class="text-3xl mt-2 md:mt-0 md:text-5xl">
            I'm
            <span class="capitalize text-5xl xl:text-6xl font-black">Benslimane Fares Houssem Eddin</span>
          </h4>
          <p class="mt-4 text-md md:text-1xl max-w-sm md:max-w-xl">
            ...
            web apps,
            <br />passionate about
            <span class="last-span relative">Designe</span>.
          </p>
          <g-link
